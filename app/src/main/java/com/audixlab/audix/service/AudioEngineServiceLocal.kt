package com.audixlab.audix.service
...
import com.audixlab.audix.MainActivity
import com.audixlab.audix.audio.EQPreset
import com.audixlab.audix.audio.EQPresetLibrary
import com.audixlab.audix.audio.EqEngine
import com.audixlab.audix.data.AppDatabase
import com.audixlab.audix.data.UserPreferencesRepository
import com.audixlab.audix.domain.GenreDetector
import com.audixlab.audix.state.SongState
...
open class AudioEngineServiceLocal : Service() {
    ...
    private lateinit var headphoneDetector: com.audixlab.audix.audio.HeadphoneDetector
    ...
    override fun onCreate() {
        ...
        headphoneDetector = com.audixlab.audix.audio.HeadphoneDetector(applicationContext)
    ...
    private fun updateSongStateAndEq(title: String, artist: String, genre: String?) {
        ...
        if (current != null && current.title == title) {
            ...
            SongState.currentSong.value = com.audixlab.audix.state.SongInfo(title, artist, genre = detectedGenre)
        }
